...
and DOI links for correctly formatted references. If usig BibTeX,
...
\item Bibliographic information for published works can be freely
  ...
  \texttt{doi = \{10.1000/182\}}. If a DOI is not available, a
...
entry. Please format your references as close as possible to the style
in this sample file.  Whenever possible, please include arXiv and DOI
links after each reference as shown in the source of this sample file.
