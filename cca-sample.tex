...
\end{verbatim}
\begin{itemize}
\item The option \verb|amsmath| can be omitted if the \texttt{amsmath}
  package is not needed.
\item The packages \texttt{geometry}, \texttt{amsthm},
  \texttt{amssymb}, \texttt{hyperref}, and \texttt{microtype} are
  automatically loaded. Please do not reload or set any options for
  these packages.
